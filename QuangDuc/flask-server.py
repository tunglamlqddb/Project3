...
import sqlite3, math, csv, json, os, pandas
...
def calculate_scores():
  ...
  #  labels = []
    ...
    with sqlite3.connect(db_path) as conn:
        ...
        df = pandas.read_csv("./results/final_potential_co_authors_" + num_records + ".csv")
    ...
    return jsonify({"msg": "done", "name" : "final_potential_co_authors_" + num_records + " .csv", "check" : df['CommonNeighbor'].to_json()})       
